...
namespace skyss0fly\DiscordMCPEPM4;
...
use skyss0fly\DiscordMCPEPM4\Events\EventListener;
    ...
    public function onEnable()
    {
        ...
        if ($this->pp == true) {
            if ($this->getServer()->getPluginManager()->getPlugin('PurePerms') == true) {
                $this->getServer()->getLogger()->info('[DiscordMCPEPM4] PurePerms Compatibility Enabled!');
            } else {
                $this->getServer()->getLogger()->warning('[DiscordMCPEPM4] PurePerms Compatibility Enabled, but PurePerms could not be found!');
            }
        }
